...
var MATL_DEFAULT = 			 26;		// (used for unrecognized material names)
...
// This function DOES NOT CHANGE values of any of its uLoc_XX member variables.
	...
	switch(nuMatl)
	{
		...
		case MATL_SNOW: 
			this.K_emit.push(0.0,      0.0,      0.0,      1.0);
			this.K_ambi.push(0.8,      0.8,  0.8,   1.0);
			this.K_diff.push(0.9,    0.9,  0.9,  1.0);
			this.K_spec.push(0.0, 0.0, 0.0, 0.8);   
			this.K_shiny = 50;
			this.K_name = "MATL_SNOW";
			break;
		case MATL_MIRROR:
			this.K_emit.push(0.0,      0.0,      0.0,      1.0);
			this.K_ambi.push(0.0,      0.0,  0.0,   1.0);
			this.K_diff.push(0.3,    0.3,  0.3,  1.0);
			this.K_spec.push(0.8, 0.8, 0.8, 0.8);   
			this.K_shiny = 50;
			this.K_name = "MATL_MIRROR";
			break;
		case MATL_PINK: 
			this.K_emit.push(0.0,      0.0,      0.0,      1.0);
			this.K_ambi.push(0.8,      0.5,  0.6,   1.0);
			this.K_diff.push(0.9,    0.9,  0.9,  1.0);
			this.K_spec.push(0.3, 0.3, 0.3, 0.8);   
			this.K_shiny = 50;
			this.K_name = "MATL_PINK";
			break;
		default:
